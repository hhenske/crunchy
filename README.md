...
<p style="color:black">[Crunchy Report Generator](archive/HISTORY.md)</p> is a Python package that accepts a loosely/specially formatted set of data and generates a report.
